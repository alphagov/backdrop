    ...
    Scenario: querying for data ON or AFTER a certain point
        Given "licensing.json" is in "foo" bucket
         ...
         then I should get back a status of "200"
          ...
          and the "1st" result should be "{"_timestamp": "2012-12-14T01:01:01+00:00", "licence_name": "Temporary events notice", "interaction": "success", "authority": "Westminster", "type": "success", "_id": "1237"}"
