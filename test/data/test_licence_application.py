...
class LicenceApplicationTest(unittest.TestCase):
    ...
    def setUp(self):
        self.visit = licence_application.LicenceApplication.from_google_row('www.foo.com/apply-for-a-licence/licence-name/body/interaction-X','republic of test')
    ...
    def test_equality(self):
        another_application = licence_application.LicenceApplication.from_google_row('www.foo.com/apply-for-a-licence/licence-name/body/interaction-X','republic of test')
