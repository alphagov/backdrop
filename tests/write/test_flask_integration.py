...
class PostDataTestCase(unittest.TestCase):
    ...
    @stub_bucket("foo", service="srv", data_type="type")
    ...
    @stub_bucket("foo", service="srv", data_type="type", bearer_token="foo-bearer-token")
    ...
    @stub_bucket("foo_bucket", service="srv", data_type="type", bearer_token="foo_bucket-bearer-token")
