...
class PermissionsTestCase(unittest.TestCase):
    ...
    def test_return_false_for_unknown_bucket(self):
        ...
        assert_that(permissions.is_user_allowed_to_bucket("anyuser", "anybucket"), is_(False))
    ...
    def test_return_false_for_unauthorised_user(self):
        ...
        assert_that(permissions.is_user_allowed_to_bucket("userthree", "mybucket"), is_(False))
    ...
    def test_return_true_for_user_in_list_for_bucket(self):
        ...
        assert_that(permissions.is_user_allowed_to_bucket("userone", "mybucket"), is_(True  ))
